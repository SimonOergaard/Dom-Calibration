...
# --- CONFIG ---
input_db_path = "/groups/icecube/simon/GNN/workspace/storage/Training/stopped_through_classification/train_model_without_configs/muon_sorted.db"
csv_filter_path = "/groups/icecube/simon/GNN/workspace/storage/Training/stopped_through_classification/stopped_muon_predictions.csv"
output_db_path = "/groups/icecube/simon/GNN/workspace/storage/Training/stopped_through_classification/train_model_without_configs/muon_stopped_sorted.db"
threshold = 0.95
chunksize = 100_000
...
filtered_event_nos = predictions.query("stopped_muon_pred > @threshold")["event_no"].unique().tolist()
